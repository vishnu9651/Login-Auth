...
//unique string
const { v4: uuidv4 } = require("bcrypt");
...
console.log("verification mail sent")
  ...
  const mailOptions = {
    ...
    html: `<p>Verif your email address to complete the signup and login into your account.</p><p>this link <b>expires in 6 houres</b>.</p> <p> Press <a href=${currentUrl + "user/verify/" + _id + "/" + uniqueString}>here</a>to proceed.</p>`,
  }
